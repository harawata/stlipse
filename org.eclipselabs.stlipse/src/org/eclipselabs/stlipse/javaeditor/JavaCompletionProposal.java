...
public class JavaCompletionProposal implements IJavaCompletionProposal
{
	...
	/**
	 * Creates a new completion proposal based on the provided information. The replacement
	 * string is considered being the display string too. All remaining fields are set to
	 * <code>null</code>.
	 * 
	...
	public JavaCompletionProposal(
		...
		int relevance)
	{
		this(replacementString, replacementOffset, replacementLength, cursorPosition, null,
